...
- Import the LocalAuthentication framework and create an instance of LAContext.
...
-  If the device is capable,then the system biometric check will begin - explaining the reason why the system is asking for authentication. 
